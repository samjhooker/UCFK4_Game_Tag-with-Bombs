...
matrix.o: matrix.c ../../drivers/avr/system.h
	$(CC) -c $(CFLAGS) $< -o $@

utils.o: utils.c ../../drivers/avr/system.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o ir_uart.o pio.o prescale.o system.o timer.o timer0.o usart1.o display.o ledmat.o navswitch.o font.o pacer.o tinygl.o matrix.o utils.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
